def generator(num, prefix, __open=0, __close=0):
    if __open == num and __close == num:
        return print(prefix)
    else:
        if __open < num:
            generator(num, prefix + '(', __open + 1, __close)
        if __close < __open:
            generator(num, prefix + ')', __open, __close + 1)


if __name__ == '__main__':
    pairs = int(input())
    answer = ''
    generator(pairs, answer)
